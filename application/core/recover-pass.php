...
if ($_POST['email'])
{
	...
	if ($db->search_email($_POST['email']))
	{
		...
		$to = $_POST['email'];
		$from = "no-reply";
		$body = "Salute cowboy,<br> If you forgot your password <br><hr><a href='https://localhost:8443/application/core/update-pass.php?cr={$encrypt}&action=reset'>Click here</a> to reset your password<hr><br>If you don't | Ignore this message";
