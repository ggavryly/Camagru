...
try {
    ...
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
 	...
 	$db->query("CREATE TABLE IF NOT EXISTS posts (id_post INT NOT NULL PRIMARY KEY AUTO_INCREMENT, id_user INT NOT NULL, post VARCHAR (512), FOREIGN KEY (id_user) REFERENCES users(id_user));");
 	...
 	$db->query("CREATE TABLE IF NOT EXISTS likes (id_like INT NOT NULL PRIMARY KEY AUTO_INCREMENT, id_post INT NOT NULL, id_user INT NOT NULL);");
